...
if(isset($_POST["btn_save"]))
{
	...
	move_uploaded_file($temp,"../Assets/UserPhoto/".$proof);
	
	
	
	$insQry="insert into tbl_user(user_name,user_contact,user_gender,user_email,user_address,user_proof,place_id,user_password,user_photo,user_doj)values('".$Name."','".$Contact."','".$Gender."','".$Email."','".$Address."','".$proof."','".$Place_id."','".$Password."','".$Photo."',curdate())";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tr>
    ...
    <tr>
      <td>Gender</td>
      <td><input type="radio" name="gender" id="male" value="Male" checked="checked" />
      <label for="male">Male 
