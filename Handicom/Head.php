    ...
    <body class="crm_body_bg" style="background:white">
        ...
        <nav class="sidebar">
            <div class="logo d-flex justify-content-between">
                <a href="HomePage.php"><h2 align="center">Welcome<br>Supplier</h2></a>
            ...
            <ul id="sidebar_menu">
                ...
                <li class="side_menu_title">
                    ...
                    <ul>
                        ...
                        <li><a href="ProductRegistration.php">ProductRegistration</a></li>
                         <li><a href="ProductList.php">ProductList</a></li>
                          <li><a href="ProductCustamization.php">CustamizationField</a></li>
               	...
               	<li class="">
                    <a   class="has-arrow" href="#" aria-expanded="false">
                        <img src="../Template/Admin/img/menu-icon/2.svg" alt="">
                        <span>BookingRecord</span>
                    </a>
                    <ul>
                        
                        <li><a href="BookingListPaid.php">BookingListPaid</a></li>
                         <li><a href="BookingListDelivered.php">BookingListDelivered</a></li>
