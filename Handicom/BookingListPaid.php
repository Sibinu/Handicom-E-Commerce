...
?>
  ...
  <table border="1"  align="right">
    ...
    <?php
	$i=0;
	$selQry="select * from tbl_product p inner join tbl_category d on p.category_id=d.category_id inner join tbl_booking bk on bk.product_id=p.product_id inner join tbl_user sp on sp.user_id=bk.user_id where bk.booking_status='1' and p.supplier_id='".$_SESSION["lgid"]."'";
    ...
    <tr>
      ...
      <td><a href="BookingListPaid.php?cid=<?php echo $data["booking_id"]?>">ViewUserNeeds</a></td>
      
        <td><a href="BookingListPaid.php?did=<?php echo $data["booking_id"]?>">MarkAsDelivered</a></td>
